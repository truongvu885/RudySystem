...
<table class="table" style="width: 700px; margin: auto;" >
    <thead>
    <tr>
        <th colspan="4">List video data</th>
        <th colspan="4">
            <form action="<c:url value="/video/search"/>">
                <input type="text" name="in_search" class="form-control" placeholder="Search by name" style="display: inline;width: 70%;padding: 0;">
